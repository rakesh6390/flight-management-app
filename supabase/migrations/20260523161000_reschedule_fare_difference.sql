-- Return fare difference from reschedule_booking RPC
...
DECLARE
  ...
  v_fare_difference numeric(10, 2);
...
BEGIN
  ...
  v_old_total := v_booking.total_price;
  ...
  IF v_new_flight.status = 'cancelled' THEN
    RAISE EXCEPTION 'new_flight_cancelled'
      USING ERRCODE = 'P0001';
  END IF;
  ...
  v_fare_difference := v_total_price - v_old_total;
  ...
  RETURN jsonb_build_object(
    ...
    'fare_difference', v_fare_difference,
